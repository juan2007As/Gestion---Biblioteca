...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function inicializarControlesiMultiples(prestamos, usuario) {
    ...
    function mostrarFormularioDevolucionMultiple(prestamos, usuario) {
        ...
        document.getElementById('btn_confirmar_devolucion_multiple').style.display = 'inline-block';
        document.getElementById('btn_cancelar_devolucion').style.display = 'inline-block';
    }
    ...
    function mostrarFormularioDevolucion(prestamo, usuario) {
        // Esta función ya no se usa pero la mantenemos por compatibilidad
        console.log('Función legacy: mostrarFormularioDevolucion');
    }
